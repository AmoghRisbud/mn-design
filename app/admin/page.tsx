      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="space-y-3">
            ...
            <Link 
              href="/admin/projects" 
              className="block w-full bg-gray-200 text-gray-900 px-4 py-3 rounded-lg font-semibold hover:bg-gray-300 transition-colors text-center"
            >
              Manage Projects
            </Link>
          </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            Welcome to the MN Design admin panel. From here you can manage your projects, view enquiries, and update your portfolio.
          </p>
